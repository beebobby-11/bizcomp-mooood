  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-b from-soft-pink via-background to-blush-pink">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        {/* Champy - Middle Right */}
        <motion.div
          className="absolute top-1/3 -right-10 w-44 md:w-56 lg:w-72 z-20"
        ...
        {/* Sereny - Bottom Left */}
        <motion.div
          className="absolute bottom-16 -left-10 w-44 md:w-56 lg:w-72 z-20"
          initial={{ opacity: 0, x: -50 }}
          animate={{ opacity: 1, x: 0 }}
        ...
        {/* Zen - Bottom Right */}
        <motion.div
          className="absolute bottom-12 -right-8 w-44 md:w-56 lg:w-72 z-20"
