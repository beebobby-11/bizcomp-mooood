    ...
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-b from-soft-pink via-background to-blush-pink">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <motion.div 
          ...
          initial={{ opacity: 0, scale: 0.8 }}
          animate={{ opacity: 1, rotate: [12, 20, 12] }}
        ...
        <motion.div 
          ...
          transition={{ opacity: { duration: 0.5 }, scale: { duration: 0.5 }, y: { duration: 6, repeat: Infinity, ease: "easeInOut", delay: 1.5 } }}
        />
        ...
        <motion.div 
          ...
          transition={{ opacity: { duration: 0.5 }, scale: { duration: 0.5 }, rotate: { duration: 5, repeat: Infinity, ease: "easeInOut", delay: 2 } }}
        />
      </div>
