    ...
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center bg-gradient-to-b from-background via-soft-pink/30 to-background">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <motion.img
          src={jollyImg}
          alt=""
          className="absolute -top-10 -left-10 w-52 md:w-64 lg:w-72 drop-shadow-lg"
        ...
        <motion.img
          src={museImg}
          alt=""
          className="absolute -top-8 -right-10 w-52 md:w-64 lg:w-72 drop-shadow-lg"
          initial={{ opacity: 0, x: 50 }}
        ...
        <motion.img
          src={serenyImg}
          alt=""
          className="absolute bottom-12 -left-12 w-44 md:w-56 lg:w-64 drop-shadow-lg"
          initial={{ opacity: 0, x: -50 }}
        ...
        <motion.img
          src={zenImg}
          alt=""
          className="absolute bottom-16 -right-10 w-44 md:w-56 lg:w-64 drop-shadow-lg"
          initial={{ opacity: 0, x: 50 }}
          animate={{ opacity: 1, x: 0, y: [0, -8, 0] }}
          transition={{ 
        ...
        <motion.img
          src={champyImg}
          alt=""
          className="absolute top-1/3 -right-14 w-40 md:w-52 lg:w-60 drop-shadow-lg"
          initial={{ opacity: 0, x: 50 }}
