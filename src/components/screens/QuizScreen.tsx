...
const questions: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'empathetic', text: "A cozy room with a comfy vibe that feels relaxing", emoji: "" },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'creative', text: "Iceland — new, unusual, different from everyone else", emoji: "" },
      { id: 'empathetic', text: "Switzerland — slow-paced city, cute cafés", emoji: "" },
      { id: 'calm', text: "New Zealand — nature, peaceful and refreshing", emoji: "" },
      { id: 'achiever', text: "Singapore — modern system, easy travel, efficient", emoji: "" },
    ],
  },
  {
    id: 4,
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'calm', text: "Simplicity and peace of mind", emoji: "" },
