  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // Character colors
        "char-outgoing": "hsl(var(--char-outgoing))",
        "char-creative": "hsl(var(--char-creative))",
        "char-empathetic": "hsl(var(--char-empathetic))",
        "char-calm": "hsl(var(--char-calm))",
        "char-achiever": "hsl(var(--char-achiever))",
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      animation: {
        ...
        "slide-up": "slide-up-fade 0.8s cubic-bezier(0.4, 0, 0.2, 1) forwards",
